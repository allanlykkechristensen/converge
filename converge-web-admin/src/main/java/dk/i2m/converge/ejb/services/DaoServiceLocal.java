...
public interface DaoServiceLocal {
    ...
    // TODO: Implement paging result
    <T extends java.lang.Object> dk.i2m.converge.ejb.services.DaoResult<T> findDaoResultWithNamedQuery(java.lang.Class<T> type, java.lang.String namedQueryName, dk.i2m.converge.ejb.services.QueryBuilder builder, int start, int resultLimit);
}

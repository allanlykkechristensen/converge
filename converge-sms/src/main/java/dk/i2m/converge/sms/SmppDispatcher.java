 ...
 * <ol>
 *     <li>create an instance of the {@link SmppDispatcher} with the the settings of the SMPP service.</li>
 *     <li>Call {@link SmppDispatcher#connect()} to connect to the SMPP service</li>
 *     <li>Send the SMS message using the {@link SmppDispatcher#dispatch(java.lang.String, java.lang.String, java.lang.String, java.lang.String) } method</li>
 *     <li>Call {@link SmppDispatcher#disconnect()} to discount from the SMPP service</li>
 * </ol>
 *
...
public class SmppDispatcher {
     ...
     * 
     * @param smppHost
     *          Host name or IP of the SMPP service
     * @param smppPort
     *          Port of the SMPP service
     * @param user
     *          Username for accessing the SMPP service
     * @param password
     *          Password for accessing the SMPP service
     * @param systemType
     *          Type of SMPP service
     * @param shortCode
     *          Short code sender, either a number or name, must be recognised 
     *          by the SMPP service
     */
     ...
     *          Message to send
     * @param recipient
     *          Phone number of the recipient (e.g. +4560812405)
     * @param serviceType
     *          Type of service
     ...
     */
    private static class MessageReceiverListenerImpl implements

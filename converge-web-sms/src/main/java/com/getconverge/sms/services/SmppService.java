...
import com.getconverge.sms.SmppDispatcher;
...
public class SmppService {
    ...
    private static final Logger LOG = Logger.getLogger(SmppService.class.getName());
    private SmppDispatcher smppDispatcher;

    /**
     * Sends an SMS through the specified SMPP service.
     *
     * @param smppHost SMPP host or IP address
     * @param smppPort SMPP port
     * @param user SMPP username
     * @param password SMPP password
     * @param systemType Type of SMPP service
     * @param shortCode Sender of the SMS
     * @param message Message to send
     * @param recipient Recipient of the SMS
     * @param serviceType Type of service used for sending the SMS
     * @param destinationPort Port used to send the SMS
